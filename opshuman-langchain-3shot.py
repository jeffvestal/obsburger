...
@obsburger has functions, you can ask it to list them to understand what it can do.

You will have 3 shots to ask questions to the AI. After the 3rd question and answer, you will stop talking to
@obsburger and generate a summary of the situation. This summary will be used by a Level 2 operator to
resolve the issue.
...
You have 3 interaction to talk to @obsburger. This is interaction {int_count} of 3.
     """
